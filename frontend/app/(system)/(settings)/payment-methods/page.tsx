...
import { PaymentMethod, PaymentMethodQueryParams } from '@/types/api';
...
export default function PaymentMethodsPage() {
  ...
  const queryParams = useMemo<PaymentMethodQueryParams>(() => {
    const params: PaymentMethodQueryParams = { page, per_page: perPage };
  ...
  const { data, isLoading, refetch, isFetching } = usePaymentMethods(queryParams);
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage payment methods available for merchants</p>
        </div>
        <PermissionGate permission="payment_methods.create">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <CardDescription>Manage predefined payment methods for merchant selection.</CardDescription>
              </div>
            ...
            <DataTableFilters
              ...
              globalSearchPlaceholder="Search payment methods..."
            />
          </div>
        </CardHeader>
                ...
                <TableRow>
                  <TableCell colSpan={6} className="h-32">
                    <div className="flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-muted-foreground font-medium">No payment methods found</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : (
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <PermissionGate permission="payment_methods.update">
                            <DropdownMenuItem onClick={() => setEditItem(item)}>
                              <Pencil className="mr-2 h-4 w-4" /> Edit
                            </DropdownMenuItem>
                          </PermissionGate>
                          <PermissionGate permission="payment_methods.delete">
                            <DropdownMenuSeparator />
      ...
      <CreatePaymentMethodDialog open={createDialogOpen} onOpenChange={setCreateDialogOpen} />
      <EditPaymentMethodDialog item={editItem} open={!!editItem} onOpenChange={(open) => !open && setEditItem(null)} />
