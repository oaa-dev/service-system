...
import { Service, ServiceQueryParams, MerchantStatus } from '@/types/api';
...
import {
  ChevronLeft, ChevronRight, MoreHorizontal, Plus, Pencil, Trash2, ClipboardList, RefreshCw, ArrowLeft, Store,
} from 'lucide-react';
...
export default function MerchantServicesPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <CreateServiceDialog merchantId={merchantId} open={createDialogOpen} onOpenChange={setCreateDialogOpen} />
      <EditServiceDialog merchantId={merchantId} item={editItem} open={!!editItem} onOpenChange={(open) => !open && setEditItem(null)} />
